...
[![Bootstrap Icons](https://img.shields.io/badge/Bootstrap_Icons-1.11.3-blue)](https://icons.getbootstrap.com)
...
- **Bootstrap Icons** — підключені локально без зовнішніх CDN-запитів
