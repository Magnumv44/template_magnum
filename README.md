...
- Кастомні сторінки помилок (404, 403, 401, 500, 503) з glitch-ефектом та анімованими фразами
...
- Налаштування кольорів шаблону через color picker: колір теми браузера, основний колір, акцентний колір, колір посилань
- Налаштування кольорів шапки сайту: назва сайту, слоган (звичайний стан та при наведенні), виділення "IT" у слогані
- Редагування фраз для кожної сторінки помилок (404, 403, 401, 500, 503) прямо з адмінки
...
- **error.php** — кастомні сторінки помилок з унікальним дизайном та анімованими фразами, що змінюються залежно від коду помилки
...
- **CSS-змінні** — всі кольори шаблону керуються через CSS custom properties з можливістю зміни через адмінку
...
├── error.php              # Шаблон сторінок помилок (404, 403, 401, 500, 503)
...
├── media/
│   ├── css/               # Bootstrap, Bootstrap Icons, template.css, offline.css, error.css
